...
\title[URM]{Umbilical Retrieval Mechanism (URM) Progress Report} % The short title appears at the bottom of every slide, the full title is only on the title page
...
%------------------------------------------------
\section{URM General Overview} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
\centering\includegraphics[clip, height=3cm]{original1}
\centering\includegraphics[clip, height=3cm]{original2}
\end{frame}
