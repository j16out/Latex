...
\title[Hydrogen Refueling Techniques]{Thermodynamic Analysis: Hydrogen Fuel Tank} % The short title appears at the bottom of every slide, the full title is only on the title page
