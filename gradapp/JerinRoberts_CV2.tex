...
\address{2165 Westsyde Rd.}{Kamloops, BC, Canada, V2B 7C3}
\mobile{(250) 682 6536}
\phone{(250) 318 0687}
...
\cventry{April, 2015}{Bachelors of Science}{Thompson Rivers University}{}{\textit{GPA -- 3.56/4.33}}{Major Physics}  % Arguments not required can be left empty
...
\cventry{Fall 2015}{Undergraduate Research Assistant}{\textsc{TRIUMF}}{Vancouver, BC}{}{M9 Prototype Muon Spectrometer Project
\newline{}
...
\item Designed Linux based Simulation (C/C++) to determine theoretical spectrometer resolution with openGL visualization and ROOT analysis.
...
\cventry{Summer 2013}{Undergraduate Research Assistant}{\textsc{Thompson Rivers University}}{Kamloops, BC}{}{Bluebird tracking using RFID technology.
\newline{}
Detailed achievements:
\begin{itemize}
...
Detailed achievements:
\begin{itemize}
\item Rebuilt High Performance Suspension Forks and Shocks (Fox,Rockshox,Manitou...)
...
\cvitem{Languages/\newline Libraries}{\textsc{C/C++}, Java, \LaTeX , Assembly, OpenGL, OpenCV, ROOT, Midas}
\cvitem{OS/Programs}{Ubuntu 14, Bash, Github, Windows 7/8/10, Solidworks, AutoCAD, FreeCAD, Eagle CAD, ROOT, \textsc R, MIDAS, Labview, Z88Aurora}
\cvitem{Devices}{VME ADC/TDC, Arduino, Altera FPGA, Raspberry pi, 
Newport Stepper Motors/Drivers, Tektronix (tekVISA)}
...
\cvlistdoubleitem{DownHill Biking}{High Altitude Ballooning}
\cvlistdoubleitem{RC Helicopters/Aircraft}{Model Rocketry}
\cvlistdoubleitem{Flight Simulation}{Programming}
...
\cventry{}{Dr. Christine Kraus}{\textsc{SNOLAB}}{Canadian Research Chair in Particle Astrophysics}{}{
tine@snolab.ca
\newline{}
705-561-8413   
}
...
\recipient{TRIUMF}{4004 Wesbrook Mall 
...
\opening{Dear 
Director of Human Resources,} % Opening greeting  
